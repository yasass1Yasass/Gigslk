...
import {Camera, Upload, Save, Eye, MapPin, DollarSign, X, PenTool} from 'lucide-react';
...
// For gallery images:
                ...
                if (isTempUrl) {
                    ...
                    if (formData) {
                        setFormData(prev => (prev ? {
                            ...prev,
                            gallery_images: prev.gallery_images.filter(url => url !== imageUrlToRemove)
                        } : null));
                    }
                }
            };
            ...
            if (authLoading || localLoading) {
                return <div className="min-h-screen flex items-center justify-center bg-slate-950 text-white">Loading
                    profile...</div>;
            }
            ...
            if (!profile || !formData) {
                return <div className="min-h-screen flex items-center justify-center bg-slate-950 text-white">Error:
                    Profile
                    data missing.</div>;
            }
                ...
                <div className="min-h-screen bg-slate-950 font-inter py-8">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                            ...
                            <div className="lg:col-span-3">
                                <div className="bg-slate-800 rounded-xl p-6">
                                    ...
                                    {/* Profile Picture */}
                                    <div className="mb-6">
                                        <label className="block text-sm font-medium text-gray-300 mb-2">Profile
                                            Picture</label>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Full
                                                Name</label>
                                            {isEditing ? (
                                                <input
                                                    type="text"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Stage Name
                                                (Optional)</label>
                                            {isEditing ? (
                                                <input
                                                    type="text"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                        <div>
                                            <label
                                                className="block text-sm font-medium text-gray-300 mb-2">Location</label>
                                            {isEditing ? (
                                                <input
                                                    type="text"
                                                    name="location"
                                                ...
                                                <p className="text-lg text-white flex items-center"><MapPin
                                                    className="h-4 w-4 mr-2 text-gray-500"/>{profile.location}</p>
                                            )}
                                        </div>

                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Performance
                                                Type</label>
                                            {isEditing ? (
                                                <select
                                    ...
                                    <div className="mt-6">
                                        <label
                                            className="block text-sm font-medium text-gray-300 mb-2">Skills/Tags</label>
                                        {isEditing ? (
                                            <>
                          ...
                          {skill}
                                    ...
                                    <div className="mt-6">
                                        <label className="block text-sm font-medium text-gray-300 mb-2">Pricing
                                            (LKR)</label>
                                        {isEditing ? (
                                            <input
                                                type="text"
                                            ...
                                            <p className="text-lg text-white flex items-center"><DollarSign
                                                className="h-4 w-4 mr-2 text-gray-500"/>{profile.price}</p>
                                        )}
                                    </div>

                                    <div className="mt-6">
                                        <label className="block text-sm font-medium text-gray-300 mb-2">Bio /
                                            Description</label>
                                        {isEditing ? (
                                            <textarea
                                                name="bio"
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-slate-800 rounded-xl p-6">
                                        ...
                                        <div
                                            ...
                                            <p className="text-gray-400 mb-4">Drag & drop videos or audio files to
                                                upload</p>
                                            {isEditing && (
                                                <>
                                                    <input
                                        ...
                                        {displayGalleryImageUrls.length > 0 ? (
                                            ...
                                            !isEditing &&
                                            <p className="text-gray-500 text-sm mt-4">No gallery images uploaded
                                                yet.</p>
                                        )}
                                    </div>
                                                ...
                                                {isEditing ? (
                                                    <button
                                                        onClick={() => setFormData(prev => (prev ? {
                                                            ...prev,
                                                            direct_booking: !prev.direct_booking
                                                        } : null))}
                        ...
                        />
                                                    ...
                                                    <span
                                                        className={`px-3 py-1 rounded-full text-sm font-medium ${profile.direct_booking ? 'bg-green-500/20 text-green-300' : 'bg-red-500/20 text-red-300'}`}>
                        {profile.direct_booking ? 'Yes' : 'No'}
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Travel
                                                    Distance (km)</label>
                                                {isEditing ? (
                                                    <div className="relative">
                                                        ...
                                                        <div
                                                            ...
                                                            <span>0 km</span>
                                                            <span
                                                                className="font-medium text-purple-400">{formData.travel_distance} km</span>
                                                            <span>200 km</span>
                                                        </div>
                                                    </div>
                                                ) : (
                                                    <p className="text-lg text-white flex items-center"><MapPin
                                                        className="h-4 w-4 mr-2 text-gray-500"/>{profile.travel_distance} km
                                                    </p>
                                                )}
                                            </div>

                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-3">Preferred
                                                    Availability</label>
